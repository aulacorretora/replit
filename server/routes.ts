...
// Importar controladores de grupos
import { 
  getGroupsByInstance, 
  getGroupById, 
  createGroup,
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post('/api/groups/:groupId/members', addGroupMember);
  app.delete('/api/groups/:groupId/members/:memberId', removeGroupMember);
  ...
  // API Keys, AI Agents, and Automations are now handled by their respective route handlers
